...
const NewCollectionProductTabs = ({ products }) => {
            ...
            <div className='container'>
                ...
                <div className='products-tabs'>
                    <Tabs>
                        ...
                        <TabPanel>
                            <div className="row justify-content-center">
                                {products.length > 0 && products.slice(2, 8).map((product) => (
                                    <div className="col-lg-4 col-md-6 col-sm-6" key={product.id}>
                                        <div className='single-products-item'>
                                            <div className="image">
                                                <Link href={`/product/${product.id}`}>
                        ...
                        <TabPanel>
                            <div className="row justify-content-center">
                                {products.length > 0 && products.slice(6, 13).map((product) => (
                                    <div className="col-lg-4 col-md-6 col-sm-6" key={product.id}>
                                        <div className='single-products-item'>
                                            <div className="image">
                                                <Link href={`/product/${product.id}`}>
                        ...
                        <TabPanel>
                            <div className="row justify-content-center">
                                {products.length > 0 && products.slice(8, 15).map((product) => (
                                    <div className="col-lg-4 col-md-6 col-sm-6" key={product.id}>
                                        <div className='single-products-item'>
                                            <div className="image">
                                                <Link href={`/product/${product.id}`}>
                        ...
                        <TabPanel>
                            <div className="row justify-content-center">
                                {products.length > 0 && products.slice(4, 10).map((product) => (
                                    <div className="col-lg-4 col-md-6 col-sm-6" key={product.id}>
                                        <div className='single-products-item'>
                                            <div className="image">
                                                <Link href={`/product/${product.id}`}>
...
export default NewCollectionProductTabs;
