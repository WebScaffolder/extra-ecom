                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-12 col-md-12">
                            <div className="search-result">
                                <h4><span>Category:</span> Fashion</h4>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-12 col-md-12">
                            <div className="pagination-area">
                                <div className="nav-links">
                                    <a href="/categories" className="previous page-numbers" title="Next Page">
                                        <i className="fas fa-arrow-left"></i>
                                    </a>
                                    <span className="page-numbers current">1</span>
                                    <a href="/categories" className="page-numbers">2</a>
                                    <a href="/categories" className="page-numbers">3</a>
                                    <a href="/categories" className="next page-numbers" title="Next Page">
